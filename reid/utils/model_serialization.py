    ...
    for i, key in enumerate(mapped_current_keys):
        for source_key, target_key in load_mapping.items():
            if source_key in key:
                ...
                print("MAPPING {} in current model to {} in loaded model.".format(key, mapped_current_keys[i]))
...
if __name__ == '__main__':
    ...
    model = Models.ResNet50(num_identities=751, last_stride=1, use_bnneck=True)
    checkpoint = torch.load('./data/data/net.pth')
